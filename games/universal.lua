...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/xylex1/LunarClient/'..readfile('newvape/profiles/commit.txt')..'/'..select(1, path:gsub('newvape/', '')), true)
		end)
...
local hash = loadstring("https://raw.githubusercontent.com/xylex1/LunarClient/main/libraries/hash.lua", 'hash')()
local prediction = loadstring('https://raw.githubusercontent.com/xylex1/LunarClient/main/libraries/prediction.lua', 'prediction')()
entitylib = loadstring('https://raw.githubusercontent.com/xylex1/LunarClient/main/libraries/entity.lua', 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
