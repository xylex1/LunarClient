...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('newlunar/assets/new/blur.png')
...
run(function()
	...
	local function CreateWindow(self)
		...
		close.Image = getcustomasset('newlunar/assets/new/close.png')
		...
		searchicon.Image = getcustomasset('newlunar/assets/new/search.png')
	...
	vape.Components.HotbarList = function(optionsettings, children, api)
		...
		textbuttonicon.Image = getcustomasset('newlunar/assets/new/add.png')
		...
		function optionapi:AddHotbar(data)
			...
			close.BackgroundColor3 = Color3.new(1, 1, 1)
			close.BackgroundTransparency = 1
			close.Image = getcustomasset('newlunar/assets/new/closemini.png')
			close.ImageColor3 = color.Light(uipallet.Text, 0.2)
			close.ImageTransparency = 0.5
			close.AutoButtonColor = false
			close.Parent = hotbar
			...
			local mounted = bedwars.Roact.mount(create('BillboardGui', {
				...
				create('Frame', {
					...
					create('ImageLabel', {
						...
						BackgroundTransparency = 1,
						Image = getcustomasset('newlunar/assets/new/blur.png'),
